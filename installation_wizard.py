...
def start_the_installation_process():
    ...
    [
        ...
        `%s.sublime-settings`. The file `%s.sublime-settings` registers all installed folders,
        packages and files to your Sublime Text. Then it can correctly later remove everything which
        belongs to it. Just do not edit this file add or removing things, as it can make the
        uninstallation delete files which it should not to.
